	...
	var setting = {
		...
		callback: {
			onClick: function (event, treeId, treeNode) {
				location.href="${ctx}/user/beginSortUser.do?orgid="+treeNode.id;
			}
		}
	};
	var zNodes =[
		...
		<div class="tab">
			<div class="tab_menu">
				<ul>
					...
					<li  class="selected" onClick='{location.href="${ctx}/user/beginSortUser.do?orgid=${org.id}"}'>用户管理</li>
...
<!-- new -->                <td>
	...
	<%-- <div style="margin-top:40px;height:30px;background-color:#f1f1f1;padding-top:5px;padding-left:30px" >
	<span class=${userPager.currentPage} >
