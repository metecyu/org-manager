...
<div class='handle' style="margin-left:0px">
			...
			<table class="inputTable tabContent">
				<tbody>
					...
					<tr>
						...
						<td>
							<input type="text" id="loginid" name="loginid" class="inputText ac_input" value="" autocomplete="off" />
							<label class="requireField">*</label>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input type="password" id="pwd" name="pwd" class="inputText ac_input" value="" autocomplete="off" />
							<label class="requireField">*</label>						
						</td>
					</tr>
					<tr>
						...
						<td>
							<input type="password" id="pwdRepeat" name="pwdRepeat" class="inputText ac_input" value="" autocomplete="off" />
							<label class="requireField">*</label>						
						</td>
					</tr>
	...
	<!-- new -->
					<tr>
						...
						<td>
							<input type="text" id="mobile" name="mobile" class="inputText ac_input" value="" autocomplete="off" />
							<!-- <label class="requireField">*</label>		 -->				
						</td>
					</tr>
	   ...
	   <!-- new -->
					<tr>
						...
						<td>
							<input type="text" id="email" name="email" class="inputText ac_input" value="" autocomplete="off" />
							<!-- <label class="requireField">*</label>		 -->				
						</td>
					</tr>
