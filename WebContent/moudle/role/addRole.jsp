		...
		<div class="input">
			...
			<table class="inputTable tabContent">
				<tbody><tr>
					...
					<td>
						<input type="text" id="roleName" name="roleName" class="inputText" value="">
				...
				<tr>
					...
					<td>
						<input type="text" id="roleSign" name="roleSign" class="inputText ac_input" value="ttt" autocomplete="off" value='ttt'>
				...
				<tr>
					...
					<td>
						<input type="text" id="rolegroup" name="rolegroup" class="inputText ac_input" value="" autocomplete="off" >
				...
				<tr>
					...
					<td>
						<textarea rows="3" cols="30" class="inputText ac_input" id="details" name="details"></textarea>
					</td>
				</tr>
			</tbody></table>
		</div>
